...
import random
from WV.models import Data,Templates,Options
from WV.forms import EnterData,EnterOptions
...
def mainPage(request):
    ...
    if request.method=="POST":
        ...
        if  form_text.is_valid():
            ...
            args['error'] = 'The file is not supported. Excel extension is expected'
